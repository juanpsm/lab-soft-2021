...
public class StudentTest {
    public static void main(String[] args) {
        Student s1 = new Student("camila", "onofri", 20, 137359, 30);
        Student s2 = new Student("celeste", "onofri", 18, 188356, 10);
        Student s3 = new Student("bianca", "adorbado", 20, 137345, 0);
        Student s4 = new Student("camila", "mura", 21, 137356, 30);

        Student[] sds = {s1, s2, s3, s4};
